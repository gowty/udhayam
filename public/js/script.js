...
function myMap() {
	var mapProp = {
		center: new google.maps.LatLng(10.9995305, 77.083961),
		zoom: 18,
...
var x = setInterval(function() {
	...
	document.getElementById('1').innerHTML = days + 'd ';
	document.getElementById('2').innerHTML = hours + 'h ';
	document.getElementById('3').innerHTML = minutes + 'm ';
	document.getElementById('4').innerHTML = seconds + 's ';
